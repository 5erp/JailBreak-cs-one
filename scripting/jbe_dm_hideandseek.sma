...
new const dm_name[] = "Прятки";
new const dm_block = 4;
new const dm_timer = 181;
new const dm_sound_file[] = "sound/csone/days_mode/hideandseek/ambience1.mp3"; //sound/csone/%s
new const dm_sound_name[] = "Операция Пластилин — Прятки";
...
public plugin_init()
{
	register_plugin("[JBE_DM] Hide And Seek", "1.1a", "Freedo.m & Serp");
	g_iDayModeHideAndSeek = jbe_register_day_mode(
...
public ClCmd_Drop(id) return PLUGIN_HANDLED;
